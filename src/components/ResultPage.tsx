    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: t.resultPage.shareText.replace('{username}', username).replace('{type}', type),
      ...
      alert(t.resultPage.shareNotSupported);
    }
  };
      ...
      <div className="w-full max-w-2xl p-8">
        <div className="bg-[var(--color-white)] rounded-3xl shadow-2xl p-12">
          <div className="text-center mb-8">
            <h2 className="text-2xl text-gray-600 mb-4">{username} {t.resultPage.yourTypeIs}</h2>
          ...
          <div className="bg-gradient-to-r from-[var(--color-yellow-light)] to-[var(--color-pink-light)] rounded-2xl p-6 mb-8">
            <h3 className="text-xl font-bold text-[var(--color-black)] mb-4">{t.resultPage.descriptionTitle}</h3>
            <p className="text-gray-700 leading-relaxed">
              {t.resultPage.descriptionPlaceholder}
            </p>
          </div>
